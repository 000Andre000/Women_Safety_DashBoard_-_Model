...
const Chatbot: React.FC = () => {
  const [messages, setMessages] = useState<Message[]>([
    {
      text: "👋 Hi! I'm your Women's Safety Assistant. Ask me about safety tips, emergencies, or reporting incidents! 🛡",
      sender: 'bot'
    }
  ]);
        ...
        <div className="fixed bottom-4 right-4 w-96 bg-white border shadow-xl rounded-xl p-4 z-50 animate-slideIn">
          ...
          <div className="flex items-center justify-between mb-3 pb-2 border-b">
            <div className="flex items-center">
              <span className="text-purple-600 font-bold text-sm">👮‍♀ Women's Safety Assistant</span>
            </div>
